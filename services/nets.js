...
exports.generateQrCode = async (req, res) => {
  const cartTotal = req.body && req.body.cartTotal ? Number(req.body.cartTotal) : 0;
  if (!cartTotal || Number.isNaN(cartTotal) || cartTotal <= 0) {
    req.flash('error', 'Invalid cart total for NETS QR.');
